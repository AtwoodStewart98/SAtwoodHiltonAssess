...
const Room2 = props => (
  <section>
    <div className="flex">
      <input
        type="checkbox"
        onChange={() => props.handleRoom2Check()}
        checked={props.check ? "checked" : ""}
      />
      <header>
        <h3 style={{ fontWeight: props.check ? null : 400 }}>Room 2</h3>
      </header>
    </div>
    <div
    ...
    >
      <div>
        ...
        <select
          ...
          onChange={e => props.nums("adult2", e.target.value)}
        >
          <option>1</option>
      ...
      <div>
        ...
        <select
          disabled={props.check ? null : "disabled"}
          onChange={e => props.nums("child2", e.target.value)}
        >
          <option>0</option>
